...
import { convertToMb, numFormate, convertToSeconds } from "../../helpers/utility";
function stats({ data }) {
	let metrics = calculateState(data);
	return <div>{aa(metrics)}</div>;
}
				...
				<div className='grid gap-7 p-4 sm:grid-cols-2 lg:grid-cols-4'>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center pt-1'>
							<div className='text-2xl font-bold self-center text-purple-700 '>
								{numFormate(matrix.totalRequests)}
							</div>
					...
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center   pt-1'>
							<div className='text-2xl self-center font-bold text-green-600 '>
								{numFormate(matrix.sucessRequests)}
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center items-center '>
							<div className='text-2xl  self-center font-bold text-red-600 '>
								{numFormate(matrix.failedRequest)}
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center items-center '>
							<div className='text-2xl  self-center font-bold text-red-600 '>
								{numFormate(matrix.networkFailed)}
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center pt-1'>
							<div className='text-2xl self-center font-bold text-blue-600 '>
								{matrix.perSecond &&
									matrix.totalCounted &&
									numFormate(parseInt(matrix.perSecond / matrix.totalCounted))}
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center pt-1'>
							<div className='text-2xl self-center font-bold text-blue-600 '>
								{matrix.responseTime &&
									matrix.totalCounted &&
									convertToSeconds(matrix.responseTime / matrix.totalCounted / 1000)}
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center pt-1'>
							<div className='text-2xl self-center font-bold text-blue-600 '>
								{matrix.readThroughput &&
									matrix.totalCounted &&
									convertToMb(matrix.readThroughput / matrix.totalCounted)}
								ps
							</div>
						</div>
					</div>
					<div className='p-5 bg-white rounded shadow-sm'>
						...
						<div className='flex justify-center pt-1'>
							<div className='text-2xl self-center font-bold text-blue-600 '>
								{matrix.writeThroughput &&
									matrix.totalCounted &&
									convertToMb(matrix.writeThroughput / matrix.totalCounted)}
								ps
							</div>
						</div>
					</div>
